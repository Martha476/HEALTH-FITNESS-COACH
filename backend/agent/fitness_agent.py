...
class FitnessCoachAgent:
    ...
    TOOLS = [
        {
            ...
            "description": (
                "Search YouTube for exercise demo videos tailored to the user's "
                "fitness goal. Call this when the user asks to see exercise demos, "
                "wants workout video recommendations, or visits the exercise library."
            ),
            "parameters": {
                "fitness_goal": "The user's primary fitness goal e.g. weight_loss, muscle_gain, hip_mobility",
                "exercise_name": "Optional specific exercise name e.g. squat, plank, deadlift",
            },
        },
    ]
    ...
    def execute_tool(self, tool_name: str, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if tool_name == "search_exercise_videos":
            return search_exercise_videos(
                fitness_goal=params.get("fitness_goal", "general"),
